...
(function() {
  var $, Die, Monster, Weapon, animatedCactus, button, corruptedOrc, daggerofdeath, daggerofshadow, dropDown, dwarfBeserker, goblin, horseMan, hugeDamage, hugeDrop, hugeHP, hundredSidedDie, inBounds, largeDamage, largeDrop, largeHP, largeZombie, loadState, longbowoffire, mapStatesRun, mediumDamage, mediumDrop, mediumHP, paladin, powerfulllongbow, print, println, printstat, prob, randomAdjective, refresh, riverMonster, showMap, sixSidedDie, smallDagger, smallDamage, smallDrop, smallHP, spider, supersword, swordofthefeather, swordofthesun, tenSidedDie, townStatesRun, twentySidedDie, visited, zombie,
  ...
  /* --------------------------------------------
       Begin weapons.coffee
  --------------------------------------------
  */


  smallDagger = new Weapon(new Die(3, 6, +3), "Dagger of awesome", 200);

  daggerofshadow = new Weapon(new Die(3, 7, +2), "Dagger of Shadow", 500);

  daggerofdeath = new Weapon(new Die(3, 8, +3), "Dagger of Death", 600);

  swordofthefeather = new Weapon(new Die(3, 8, -3), "Sword of the feather", 300);

  supersword = new Weapon(new Die(6, 6, -6), "Super Sword", 600);

  swordofthesun = new Weapon(new Die(5, 9, -5), "Sword of the Sun", 750);

  longbowoffire = new Weapon(new Die(5, 4, -5), "Long Bow of Fire", 400);
  ...
  */
  ...
  refresh = function() {
    ...
    return setTimeout(refresh, 10);
  };

  /* --------------------------------------------
       Begin creatures.coffee
  --------------------------------------------
  */
  ...
  */
  ...
  /* --------------------------------------------
       Begin mapStates.coffee
  --------------------------------------------
  */


  mapStatesRun = function() {
    var damage;
