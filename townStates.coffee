townStatesRun = ->
	...
	# --- Mage ---
		...
		println "I don't have any potions in stock at the moment, but I'll have some more later."
		setState "mage"
	else if @state == "staffs"
		println "I'm sorry, but I don't have any staffs at the moment. Do come back later."
		setState "mage"
